...
from backend.shared.http_client import AsyncHTTPClient
    ...
    async def test_get_request(self) -> None:
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            async with AsyncHTTPClient() as client:
                ...
                mock_session.get.assert_called_once_with("https://api.example.com/test", headers=None)
    
    @pytest.mark.asyncio
    async def test_get_request_with_headers(self) -> None:
        """Test GET request with custom headers."""
        mock_response_data: Dict[str, Any] = {"data": "test"}
        headers: Dict[str, Any] = {"Authorization": "Bearer token123", "Content-Type": "application/json"}
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            async with AsyncHTTPClient() as client:
                ...
                assert result == mock_response_data
                mock_session.get.assert_called_once_with("https://api.example.com/test", headers=headers)
    ...
    async def test_post_request(self) -> None:
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            async with AsyncHTTPClient() as client:
                ...
                assert result == mock_response_data
                mock_session.post.assert_called_once_with("https://api.example.com/create", json=post_data, headers=None)
    ...
    async def test_put_request(self) -> None:
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            async with AsyncHTTPClient() as client:
                ...
                assert result == mock_response_data
                mock_session.put.assert_called_once_with("https://api.example.com/update/123", json=put_data, headers=None)
    ...
    async def test_delete_request(self) -> None:
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            async with AsyncHTTPClient() as client:
                ...
                assert result == mock_response_data
                mock_session.delete.assert_called_once_with("https://api.example.com/delete/123", headers=None)
